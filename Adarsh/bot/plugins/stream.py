    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Contact Developer [Rohesh_Gavit](https://telegram.me/MKV_FILES_ROHESH) he will help you.**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ʙᴏss](https://telegram.me/Filmy_Rohesh)**",
...
<b>❇️  ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @Filmy_Rohesh</b>"""
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton('🥰 𝒋𝒐𝒊𝒏 𝒎𝒚 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 𝒄𝒉𝒂𝒏𝒏𝒆𝒍   🥰', url='https://t.me/Filmy_Rohesh')]])
        )
